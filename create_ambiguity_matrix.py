...
if __name__ == "__main__":
    ...
    cam_pos = [0]*img_nb
    with open(os.path.join("data", camera_pos_file), 'r') as csvfile:
    ...
    for i in range(pairs_nb):
        img_pair = pairs[i]
        img_1_name = os.path.join(folder, "viewpoint" + str(img_pair[0]) + ".png")
        img_2_name = os.path.join(folder, "viewpoint" + str(img_pair[1]) + ".png")
